...
- [产品说明 v4.0（DSH 原生版）](docs/兰亭_产品说明_v4.0.html)：它是什么、怎么装、为什么选 DSH——15 个原生工具 + 会话协议自动执行 + 换方法论不换引擎
- [技术白皮书 v4.0（DSH 原生版）](docs/兰亭_技术白皮书_v4.0.html)：工具管线、事件机制、记忆双轨、已知限制如实说
